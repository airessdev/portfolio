...
const Portfolio = () => {
  ...
  // Ensure 'lien' starts with 'https://'
  const formattedLien = lien.startsWith("http") ? lien : `https://${lien}`;
    ...
    <>
      ...
      <div className="housing-main">
        ...
        <div className="housing-collapse">
          ...
          <Collapse title="Liens">
            <ul>
              <li>https://github.com/airessdev/</li>
              <li>{formattedLien}</li>
            </ul>
          </Collapse>
        </div>
        ...
        <div className="frame-container">
          <iframe className="frame" title="mon site" src={formattedLien}></iframe>
        </div>
      </div>
      <Footer />
    </>
